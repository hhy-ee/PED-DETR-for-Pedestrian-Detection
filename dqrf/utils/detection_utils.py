...
def annotations_to_instances(annos, image_size, mask_format="polygon", allow_oob=False):
    """
    ...
    vis_ratio = [obj["vis_ratio"] for obj in annos]
    vis_ratio = torch.tensor(vis_ratio, dtype=torch.float64)
    target.gt_vis_ratio = vis_ratio
